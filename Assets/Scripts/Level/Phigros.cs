...
namespace PigeonB1587.prpu
{
    public class Phigros
    {
        ...
        // Phi 速度事件转换成 世界缩放速度事件速度缩放比 6
        public const double speedScale = 6d;

        //理论上最大分数为[67108863, 31, 32] (n = 2147483647)，但是由于多种原因导致实际上最大分数为[31249, 31, 32]，即 n = 999999 
        public static int[] ToMixedFraction(int n) => new int[] { n / 32 + (n % 32 < 0 ? -1 : 0), (n % 32 + 32) % 32, 32 };
